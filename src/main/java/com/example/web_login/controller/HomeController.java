...
public class HomeController {
    ...
    public String showInvoicePage() {
        return "invoice"; // Make sure invoice.html is inside `src/main/resources/templates`
    }

    @GetMapping("/customers")
    public String showCustomerSPage() {
        return "customers"; // Make sure invoice.html is inside `src/main/resources/templates`
    }
}
